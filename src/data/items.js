...
export const ITEM_BASES = {
    ...
    axe_war: { name: 'War Axe', slot: SLOT.MAINHAND, type: 'axe', icon: 'item_axe', minDmg: 8, maxDmg: 15, atkSpd: 0.9, req: { str: 25 }, size: [1, 3], price: 200 },
    ...
    zweihander: { name: 'Zweihander', slot: SLOT.MAINHAND, type: 'sword', icon: 'item_sword', minDmg: 15, maxDmg: 35, atkSpd: 0.8, req: { str: 50, dex: 20 }, size: [2, 4], price: 500 },
    war_bow: { name: 'War Bow', slot: SLOT.MAINHAND, type: 'bow', icon: 'item_bow_long', minDmg: 10, maxDmg: 28, atkSpd: 1.2, req: { dex: 60 }, size: [2, 4], price: 450 },
    war_hammer: { name: 'War Hammer', slot: SLOT.MAINHAND, type: 'mace', icon: 'item_war_hammer', minDmg: 12, maxDmg: 22, atkSpd: 0.8, req: { str: 45 }, size: [2, 3], price: 350 },
    war_axe: { name: 'War Axe', slot: SLOT.MAINHAND, type: 'axe', icon: 'item_axe', minDmg: 14, maxDmg: 26, atkSpd: 0.9, req: { str: 50 }, size: [2, 3], price: 380 },
    ...
    plate_mail: { name: 'Heavy Plate', slot: SLOT.CHEST, type: 'armor', icon: 'item_plate_mail', armor: 60, req: { str: 60 }, size: [2, 3], price: 500 },
    chain_mail: { name: 'Chain Mail', slot: SLOT.CHEST, type: 'armor', icon: 'item_chain_mail', armor: 25, req: { str: 25 }, size: [2, 3], price: 150 },
    chest: { name: 'Breastplate', slot: SLOT.CHEST, type: 'armor', icon: 'item_chest', armor: 18, size: [2, 2], price: 100 },
    ...
    helm_great: { name: 'Great Helm', slot: SLOT.HEAD, type: 'helm', icon: 'item_great_helm', armor: 15, req: { str: 25 }, size: [2, 2], price: 120 },
    great_helm: { name: 'Great Helm', slot: SLOT.HEAD, type: 'helm', icon: 'item_great_helm', armor: 15, req: { str: 25 }, size: [2, 2], price: 120 },
    ...
    shield_royal: { name: 'Royal Shield', slot: SLOT.OFFHAND, type: 'shield', icon: 'item_shield', armor: 40, block: 40, req: { str: 60 }, size: [2, 3], price: 500 },
    tower_shield: { name: 'Tower Shield', slot: SLOT.OFFHAND, type: 'shield', icon: 'item_shield', armor: 35, block: 35, req: { str: 55 }, size: [2, 3], price: 400 },
    ...
    book_of_skill: { name: "Book of Skill", slot: 'none', type: 'potion', icon: 'item_book_skill', size: [1, 1], price: 0, flavor: '"Read this to gain a permanent skill point."', identified: true },
    staff_of_kings: { name: "Staff of Kings", slot: 'none', type: 'material', icon: 'item_staff_kings', size: [1, 3], price: 0, flavor: '"An ancient mahogany staff, part of the Horadric legend."', identified: true },
    viper_amulet: { name: "Viper Amulet", slot: 'none', type: 'material', icon: 'item_amulet_viper', size: [1, 1], price: 0, flavor: '"The Amulet of the Viper, glowing with forbidden magic."', identified: true },
    horadric_staff: { name: "Horadric Staff", slot: SLOT.MAINHAND, type: 'staff', icon: 'item_staff_kings', minDmg: 12, maxDmg: 30, atkSpd: 0.7, req: { str: 25 }, size: [1, 4], mods: [{ stat: 'allRes', value: 10 }, { stat: 'flatMP', value: 50 }], flavor: '"The powerful Horadric Staff, restored at last."', identified: true },
